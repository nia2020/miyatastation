...
const SECTIONS = [
  ...
  { id: "events", label: "イベント情報", href: "/dashboard?section=events", icon: Calendar },
  { id: "forms", label: "メッセージ募集", href: "/dashboard?section=forms", icon: MessageSquare },
  { id: "chat", label: "タイムライン", href: "/dashboard?section=chat", icon: Hash },
] as const;
