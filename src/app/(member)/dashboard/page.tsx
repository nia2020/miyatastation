        ...
        {section === "home" && (
          <div className="space-y-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {HUB_LINKS.map(({ href, title, description }) => (
                <Link
                  key={href}
                  href={href}
                  className="block rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 p-6 transition-all hover:border-indigo-300 dark:hover:border-indigo-600 hover:shadow-md"
                >
